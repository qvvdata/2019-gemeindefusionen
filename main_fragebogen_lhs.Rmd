...
ggplot(vwmit729_90, aes(fj, soll, color = gsrbetr)) +
  geom_line() +
  ggtitle("Verwaltungsausgaben absolut mit 729/90*") +
  theme_addendum()


ggplot(vwohne729_90_, aes(fj, soll, color = gsrbetr)) +
  geom_line() +
  ggtitle("Verwaltungsausgaben absolut ohne 729/90*") +
  theme_addendum()
```
...
ggplot(vwohne729_90_einwohner2010_progemeinde_gesamt, aes(fj, vwausgabenprokopf, color=gsrbetr)) +
  geom_line() +
  ggtitle("Verwaltungsausgaben/Kopf Einwohner2010 ohne 729/90")
```