...
personalkostenprokopf_map <- bind_rows(personalkostenprokopf_fus, personalkostenprokopf_nfus)
...
aoa_stmk_ansaetze <- ansaetze_data %>%
  ...
  select(fj, gkz_neu, name, soll, gruppe, gsrbetr) %>%
  ungroup() %>%
  spread(fj, soll) %>%
  mutate(avg12_14 = (`2012`+`2013`+`2014`)/3, 
         avg15_17 = (`2015`+`2016`+`2017`)/3, 
