...
write_csv(wahlen_bordermanned_wb_long, path = "interaktiv/teilhabe/wahlen_bordermanned_wb_long.csv")
...
write_csv(wahlen_bordermanned_wb_fp, path = "interaktiv/teilhabe/wahlen_bordermanned_wb_fp.csv")
